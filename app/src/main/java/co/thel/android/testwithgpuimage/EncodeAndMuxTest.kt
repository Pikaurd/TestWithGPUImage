...
class EncodeAndMuxTest {
     ...
     */
    fun testEncodeVideoToMp4(surface: Surface? = null) {
        // QVGA at 2Mbps
        mWidth = 320
        mHeight = 240
        mBitRate = 2000000
...
//                generateSurfaceFrame(i)
     ...
     */
    private fun prepareEncoder(surface: Surface? = null) {
...
//        mInputSurface = CodecInputSurface(mEncoder!!.createInputSurface())
        mInputSurface = CodecInputSurface(getRecodingSurface(surface))
        mEncoder!!.start()
    ...
    private fun getRecodingSurface(surface: Surface? = null): Surface {
        val recordingSurface: Surface
        when (surface == null) {
            true -> recordingSurface = mEncoder!!.createInputSurface()
            false -> recordingSurface = surface!!
        }
